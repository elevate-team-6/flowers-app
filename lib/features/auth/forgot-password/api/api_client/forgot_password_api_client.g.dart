...
part of 'forgot_password_api_client.dart';
...
class _ForgotPasswordApiClient implements ForgotPasswordApiClient {
  _ForgotPasswordApiClient(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<VerifyResetCodeResponse> verifyResetCode(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<VerifyResetCodeResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late VerifyResetCodeResponse _value;
    try {
      _value = VerifyResetCodeResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
