...
part of 'edit_profile_api_client.dart';
...
class _EditProfileApiClient implements EditProfileApiClient {
  _EditProfileApiClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<UploadPhotoResponse> uploadPhoto(MultipartFile image) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = FormData();
    _data.files.add(MapEntry('photo', image));
    final _options = _setStreamType<UploadPhotoResponse>(
      Options(
            method: 'PUT',
            headers: _headers,
            extra: _extra,
