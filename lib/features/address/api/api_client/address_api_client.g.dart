...
part of 'address_api_client.dart';
...
class _AddressApiClient implements AddressApiClient {
  _AddressApiClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<AddressResponse> addAddress(AddressModel address) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<AddressResponse> updateAddress(String id, AddressModel address) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
